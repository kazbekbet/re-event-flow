import { redirect, setAsyncEvent, setComputedStore, setEvent, setStore } from '../../lib/main.ts';
...
export const _asyncIncrement = setAsyncEvent(({ countTo, delay, isReject }: AsyncIncrementPayload) =>
